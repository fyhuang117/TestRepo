...
<div class="container-fluid">
    ...
    <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main"> <br>
        ...
        <form action="" method="post" id="search_form">
              <p><a href="javascript:void(0)" style=" float:right; margin-bottom:6px;" class="btn btn-primary" onclick="$('#myModal1').modal('show');">添加新配件类型</a>
    ...
    <div class="modal-content">
        ...
        <div class="modal-body">
            ...
            <tr>
                  ...
                  <td><!--<input type="text" name="nam" class="form-control" style="width:220px; display:inline-block; "><a href="javascript:$('#myModal1').modal('show');" style=" margin:0 0 2px 4px;" class="btn btn-default">搜索</a>
				  <div>
