      ...
      <div class="row">
		...
		<table width="100%" border="0" cellspacing="0" cellpadding="0" class="table table-striped" id="ul_zy">
          <tr>
            ...
            <th  width="5%" align="center">商圈</th>
            <th  width="10%" align="center">地址</th>
            <th  width="10%" align="center">身份证</th>
            <th  width="10%" align="center">营业执照</th>
            <th  width="10%" align="center">代理许可</th>
            <th  width="10%" align="center">其他图片</th>
          ...
          <?php 
          	...
          	foreach ($user_list as $_user_){
          		echo '<tr class="bottbords">
							...
							<td width="5%" align="center">'.$_user_->business_area->name.'</td>
				            <td  width="10%" align="center">'.$_user_->adr.'</td>
							<td width="10%" align="center">';
          		if($_user_->lp1 != ''){
          			echo '<a href="'.LP1_URL.$_user_->lp1.'" target="_blank"><img src="'.LP1_URL.$_user_->lp1.'" height="50" width="50"/></a>';
          		}
          		if($_user_->lp2 != ''){
          			echo '<a href="'.LP2_URL.$_user_->lp2.'" target="_blank"><img src="'.LP2_URL.$_user_->lp2.'" height="50" width="50"/></a>';
          		}
				echo '</td>
							<td width="10%" align="center">';
				if($_user_->license != ''){
					echo '<a href="'.LICENSE_URL.$_user_->license.'" target="_blank"><img src="'.LICENSE_URL.$_user_->license.'" height="50" width="50"/></a>';
				}
				echo '</td>
    			<td width="10%" align="center">';
				if($_user_->agent != ''){
					echo '<a href="'.AGENT_URL.$_user_->agent.'" target="_blank"><img src="'.AGENT_URL.$_user_->agent.'" height="50" width="50"/></a>';
				}
				echo '</td>
        		<td width="10%" align="center">';
				if($_user_->pic != ''){
					echo '<a href="'.PIC_URL.$_user_->pic.'" target="_blank"><img src="'.PIC_URL.$_user_->pic.'" height="50" width="50"/></a>';
				}
				echo '</td>
							<td width="10%" align="center">';
				if($_user_->enb == 0){
					...
					echo '已审核';
				}else if($_user_->enb == 2){
					echo '审核未通过';
				}else{
					echo '待审核';
				}
				echo '</td>
							 <td width="30%" align="center" class="border_ri_no"><a href="#" class="a_css" onClick="edit('.$_user_->id.');">设置商圈</a>&nbsp;&nbsp;';
				if($_user_->enb == 3){
              ...
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">设置商圈</h4>
                  </div>
