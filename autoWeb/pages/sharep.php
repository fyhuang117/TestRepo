...
<html>
	...
	*::-webkit-input-placeholder {
	...
	<div style="position:absolute; width:320px; height:340px; margin:auto; top:0; left:0; right:0; bottom:0; text-align:center; color:#7e7e7e; font-weight:bold;">
		...
		<a href="javascript:void(0);" style="display:block; line-height:38px; font-size:1.2em; font-weight:bold; border-radius:12px; background:#eec06a; color:#000; width:80%; margin:auto; text-decoration:none; padding:2px;" onClick="document.getElementById('form1').submit()">领取Ole卷</a>
	</form>
	</div>
