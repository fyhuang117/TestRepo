<?php
	...
	define('SERVICE_URL','http://112.126.73.60/auto/resource/');
...
*/
	...
	define('VERSION_URL_SELL_ANDROID','http://112.126.73.60/auto/download/sell.apk');			//卖家下载地址
	
	define('VERSION_NUM_BUY',3);					//买家版本号
	define('VERSION_STR_BUY','1.2');					//买家版本名
	define('VERSION_URL_BUY_ANDROID','http://112.126.73.60/auto/download/buy.apk');			//买家下载地址
?>